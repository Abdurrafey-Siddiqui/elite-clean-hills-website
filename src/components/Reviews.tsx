...
const reviews = [
  {
    ...
    name: "Sarah Jenkins",
    location: "Bondi",
    text: "Absolutely incredible. My driveway looks brand new. The team was punctual, polite, and the results speak for themselves. Highly recommend!",
    rating: 5,
  },
  {
    id: 2,
    name: "Michael Chen",
    location: "Chatswood",
    text: "I didn't realize how dirty our patio was until they cleaned it. It's completely transformed our outdoor entertaining area just in time for summer.",
    rating: 5,
  },
  {
    id: 3,
    name: "Emma Thompson",
    location: "Manly",
    text: "Professional from start to finish. The quote was transparent, the price was fair, and the house exterior gleams now. Will definitely use them again.",
    rating: 5,
  }
];
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div className="max-w-2xl">
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">
              Loved by <span className="text-brand-blue">Sydney</span> Homeowners
            </h2>
